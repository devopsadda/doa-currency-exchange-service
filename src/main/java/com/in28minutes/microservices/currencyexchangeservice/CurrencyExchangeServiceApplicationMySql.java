...
public class CurrencyExchangeServiceApplicationMySql implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		if (count == 0) {
			...
			repository.save(new ExchangeValue(10004L, "CAD", "INR", BigDecimal.valueOf(61)));
			repository.save(new ExchangeValue(10005L, "AED", "INR", BigDecimal.valueOf(21)));
			repository.save(new ExchangeValue(10006L, "SAR", "INR", BigDecimal.valueOf(21)));
		}
	}
